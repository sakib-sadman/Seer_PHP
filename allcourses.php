...
$query2 = "SELECT * from cc";
// $query2 = "SELECT * from course INNER JOIN cc ON course.c_name = cc.c_name AND course.section = cc.section";
        ...
        if(isset($_POST['submit']))
               {
                   ...
                   $sql4 = "INSERT INTO course(c_name, section, teacher_id) VALUES('$c_name', '$section', '$id')";
